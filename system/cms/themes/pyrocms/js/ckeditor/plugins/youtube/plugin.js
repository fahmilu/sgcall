...
( function() {
	...
	{
		lang: [ 'en', 'id', 'pt', 'ja', 'hu', 'it', 'fr', 'tr', 'ru', 'de', 'ar', 'nl', 'pl', 'vi', 'zh', 'el', 'he', 'es', 'nb', 'nn', 'fi', 'et', 'sk', 'cs'],
					...
					onOk: function()
					{
						...
						if ( this.getContentElement( 'youtubePlugin', 'txtEmbed' ).isEnabled() )
						{
							...
							if ( this.getContentElement( 'youtubePlugin', 'chkOlderCode' ).getValue() === true )
							{
								...
								content += '<iframe class="embed-responsive-item" width="' + width + '" height="' + height + '" src="' + url + '" ' + responsiveStyle;
