		...
		<div id="content-body">
			...
			<?php $this->load->view('admin/partials/notices') ?>
				...
				<div class="form_inputs">
					<ul>
						<li>
							<div class="input animated fadeIn" id="login-un"><input type="text" name="email" placeholder="<?php echo lang('global:email'); ?> or Username"/></div>
						</li>
...
<footer id="login-footer">
	<div class="wrapper animated fadeIn" id="login-credits">
		Copyright &copy; 2019 - <?php echo date('Y'); ?> biroproject_ 
	</div>
</footer>
</body>
</html>