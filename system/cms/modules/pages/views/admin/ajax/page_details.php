...
<fieldset>
	...
	<p>
		<strong><?php echo lang('global:slug') ?> (en):</strong>
		<a href="<?php echo !empty($page->uri_en) ? $page->uri_en : $page->slug_en ?>" target="_blank">
			/<?php echo !empty($page->uri_en) ? $page->uri_en : $page->slug_en ?>
		</a>
	</p>
	<p>
