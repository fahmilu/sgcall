...
<?php endif ?>
			...
			<li class="<?php echo alternator('', 'even') ?>">
				<label for="title_en"><?php echo lang('global:title');?> (EN)<span>*</span></label>
				<?php echo form_input('title_en', $link->title_en, 'maxlength="50" class="text"') ?>
			</li>
			...
			<li class="<?php echo alternator('', 'even') ?>">
				...
				<div id="navigation-url" style="<?php echo @$link->link_type == 'url' ? '' : 'display:none' ?>">
					...
					<br />
					<br />
					<label class="label" for="url_en"><?php echo lang('nav:url_label');?>(EN)</label>
					<input type="text" id="url_en" name="url_en" value="<?php echo empty($link->url_en) ? 'http://' : $link->url_en ?>" />
				</div>
				...
				<div id="navigation-uri" style="<?php echo @$link->link_type == 'uri' ? '' : 'display:none' ?>">
					...
					<br />
					<br />
					<label class="label" for="uri_en"><?php echo lang('nav:uri_label');?>(EN)</label>
					<input type="text" id="uri_en" name="uri_en" value="<?php echo $link->uri_en; ?>" />
				</div>
