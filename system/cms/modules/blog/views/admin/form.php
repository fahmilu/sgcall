		...
		<fieldset>
			<ul>
				...
				<li>
					...
					<div class="input"><?php echo form_input('title', htmlspecialchars_decode($post->title), 'maxlength="100" style="width: 50%;" id="title"') ?></div>
				</li>
	
				<li>
					<label for="slug"><?php echo lang('global:slug') ?> <span>*</span></label>
					<div class="input"><?php echo form_input('slug', $post->slug, 'maxlength="100" style="width: 50%;"') ?></div>
				</li>
				...
				<?php else: ?>
					<li>
						...
						<div class="input">
							...
							), $post->comments_enabled ? $post->comments_enabled : 'no') ?>
						</div>
					</li>
				<?php endif; ?>
			</ul>
