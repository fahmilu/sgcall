<section class="title">
	<h4><?php echo lang('gallery_upload_label'); ?></h4>
</section>
...
<fieldset>
	<ul>
        ...
        <li>
            <label for="category_id"><?php echo lang('gallery_category_label'); ?></label>
            <div class="input">
                <?php echo form_dropdown('category_id', $category_options, $slide->category_id); ?>
            </div>
        </li>
<!-- 		<li>
			<label><?php echo lang('gallery_title_label'); ?></label>
			<div class="input">
		...
		<li>
			<label><?php echo lang('gallery_current_image_label'); ?></label>
			<div class="input">
				<div id="slidethumb">
				...
				<?php else: ?>
					<span class="no-image"><?php echo lang('gallery_no_image_yet') ?></span>
		...
		<li>
			<label>Gallery<small><?php echo sprintf(lang('gallery_image_dimension_label'), $this->settings->gallery_width, $this->settings->gallery_height); ?></small></label>
			<div class="input">
...
<!-- 		<li>
			<label><?php echo lang('gallery_caption_label'); ?></label>
			<div class="input">
		...
		<li>
			<label for="slideurl">IG Post URL</label>
			<div class="input">
				<?php echo form_input('url', $slide->url, ' id="slideurl" style="width: 500px;"'); ?>
			</div>
		</li>


<!-- 		<li>
			<label for="slideurl"><?php echo lang('gallery_url_name'); ?></label>
			<div class="input">
...
<!-- 	<fieldset>
		...
		<ul>
			<li>
				<label for="slidecredit"><?php echo lang('gallery_credit_label'); ?></label>
				<div class="input">
			...
			<li>
				<label for="slidedescription"><?php echo lang('gallery_description_label'); ?></label>
				<div class="input">
