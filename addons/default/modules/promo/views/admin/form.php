...
<div id="maincontactform" class="form_inputs">
    <?php echo form_open_multipart(uri_string(), array('id' => 'promo-form')) ?>
<fieldset>
	<ul>
        <li>
        ...
        <li><label><?php echo lang('lbl_price', 'price') ?> <span>*</span></label>
            <div class="input"><?php echo form_input('price', $data->price, 'class="textfield" placeholder="IDR 2.000.000,-" style="width: 200px;"') ?></div>
        </li>
        <li>
            <label><?php echo lang('lbl_photo', 'photo') ?></label>
            <div class="input">
                <?php if($data->photo){ ?>
                    <img src="<?php echo UPLOAD_PATH.'promo/'.$data->photo;?>" style="display:block;margin-bottom:10px; height: 200px;" id="imgInp" />
